...
const DelegateButton = () => {
    ...
    const {
        data: delegateHash,
        isPending: delegateIsPending,
        isError: delegateIsError,
        writeContract: delegateWriteContract,
    } = useWriteContract();

    const {
        isLoading: delegateIsConfirming,
        isSuccess: delegateIsConfirmed,
        isError: delegateIsReverted,
    } = useWaitForTransactionReceipt({ confirmations: 2, hash: delegateHash });
        ...
        <div className="">
            ...
            >
                ...
                <DialogContent>
                    ...
                    {
                        (delegateIsPending || delegateIsError || delegateIsConfirming || delegateIsConfirmed || delegateIsReverted) && <LoadingTransactionHash type="Delegate your voting power to Wizard Wealth." isConfirmed={delegateIsConfirming} isReverted={delegateIsReverted} isError={delegateIsError} hash={delegateHash} className="flex flex-col gap-1 justify-center items-center" />
                    }
                </DialogContent>
            </Dialog>
        </div>

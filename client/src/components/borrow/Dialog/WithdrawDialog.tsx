        ...
        <div className="flex flex-col justify-center gap-5">
            ...
            <div className="flex flex-col w-full border-2 border-neutral-400 rounded-xl px-4 py-2 gap-2">
              ...
              <div className="flex flex-row items-center justify-between text-sm">
                ...
                <div className="flex flex-row items-center gap-3">
                  ...
                  <span className="cursor-pointer font-bold" onClick={() => setAmount(pool.balance)}>Max</span>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <DialogContent>
              ...
              {
                (isPending || isError || isConfirming || isConfirmed || isReverted) && <LoadingTransactionHash type="Withdraw" isConfirmed={isConfirmed} isReverted={isReverted} isError={isError} hash={hash} className="flex flex-col gap-1 justify-center items-center" />
              }
            </DialogContent>
          </Dialog>
        </div>
